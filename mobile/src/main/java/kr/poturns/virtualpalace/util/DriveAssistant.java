...
public class DriveAssistant {
     ...
     * DriveFileApi
     */
    public final IDriveFileApi DriveFileApi;
    /**
     * DriveFolderApi
     */
    public final IDriveFolderApi DriveFolderApi;
    /**
     * DriveContentsApi
     */
    public final IDriveContentsApi DriveContentsApi;
    ...
    public DriveAssistant(Context context) {
        ...
        DriveFileApi = new IDriveFileApi();
        DriveFolderApi = new IDriveFolderApi();
        DriveContentsApi = new IDriveContentsApi(mGoogleApiClient);
    }
    ...
    public final void destroy() {
        if (mGoogleApiClient != null) {
            mGoogleApiClient.unregisterConnectionCallbacks(CONNECTION_CALLBACKS);
            mGoogleApiClient.unregisterConnectionFailedListener(CONNECTION_FAIL_CALLBACK);
            mGoogleApiClient.disconnect();
    ...
    private final GoogleApiClient.ConnectionCallbacks CONNECTION_CALLBACKS = new GoogleApiClient.ConnectionCallbacks() {
        @Override
    ...
    private final GoogleApiClient.OnConnectionFailedListener CONNECTION_FAIL_CALLBACK = new GoogleApiClient.OnConnectionFailedListener() {
        @Override
    ...
    public DriveContents openFile(DriveId id, @FileMode int mode) {
        return DriveFileApi.openFile(getFile(id), mode);
    }
     ...
     * DriveFile API
     */
    public final class IDriveFileApi {
     ...
     * DriveFolder API
     */
    public final class IDriveFolderApi {
     ...
     * DriveContents API
     */
    public static final class IDriveContentsApi{
        private GoogleApiClient mGoogleApiClient;
        IDriveContentsApi(GoogleApiClient googleApiClient) {
