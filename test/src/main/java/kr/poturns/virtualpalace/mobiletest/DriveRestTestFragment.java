 ...
 *
 * DriveRestAssistant test Fragment
 */
public class DriveRestTestFragment extends Fragment {
    private DriveRestAssistant driveRestAssistant;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        driveRestAssistant = new DriveRestAssistant(getActivity());
        initClient();
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        return inflater.inflate(R.layout.fragment_drive_rest, container, false);
    }
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                if (DriveRestAssistant.isFolder(file))
    ...
    public void onDestroy() {
        super.onDestroy();
        driveRestAssistant.destroy();
    }

    private void initClient() {
        requestChildren(DriveRestAssistant.FOLDER_ID_ROOT);
    }
    ...
    private void requestChildren(final String fileId) {
        ...
        AsyncTask.execute(new Runnable() {
            ...
            public void run() {
                try {
                    final List<File> list = driveRestAssistant.requestChildFileList(fileId);
    ...
    private void requestParent(final String fileId) {
        ...
        AsyncTask.execute(new Runnable() {
            ...
            public void run() {
                try {
                    final List<ParentReference> parentReferenceList = driveRestAssistant.requestParentReferenceList(fileId);
                    final List<File> parentList = driveRestAssistant.requestParentList(parentReferenceList);
                    String folderId = parentList.get(0).getId();
                    final List<File> list = driveRestAssistant.requestChildFileList(folderId);
        ...
        AsyncTask.execute(new Runnable() {
            ...
            public void run() {
                try {
                    ...
                    InputStream in = driveRestAssistant.openFile(file);

                    if (in == null)
                        throw new IOException("downloadUrl == null");

                    IOUtils.readContentToFile(in, downloadFile);
    ...
    public boolean onBackPressed() {
        if (DriveRestAssistant.FOLDER_ID_ROOT.equals(mCurrentFolderId) || (parentReference != null && parentReference.getIsRoot()))
            return false;
    ...
    private class Adapter extends ArrayAdapter<File> {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            textView.setCompoundDrawablesWithIntrinsicBounds(DriveRestAssistant.isFolder(file) ? R.drawable.ic_action_file_folder : R.drawable.ic_action_editor_insert_drive_file, 0, 0, 0);
